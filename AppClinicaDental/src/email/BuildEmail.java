...
public class BuildEmail {
   ...
   public void sendEmail(String toAddress, String subject, String mensaje, File filename) throws AddressException, MessagingException, IOException {
        ...
        pdf.setFileName(filename.toString()+".pdf");
